...
public class DragSpellOnTarget : DraggingActions {
    ...
    public TargetingOptions Targets = TargetingOptions.Enemy;
    ...
    {
        if (whereIsThisCard.VisualState != VisualStates.Transition && whereIsThisCard.VisualState != VisualStates.LowTable && whereIsThisCard.VisualState != VisualStates.TopTable)
        {
