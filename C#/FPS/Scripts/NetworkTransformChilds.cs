...
namespace UnityEngine.Networking
{
    ...
    public class NetworkTransformChilds : NetworkBehaviour
    {
        [SerializeField]
        Transform m_Target;
        ...
        void OnValidate()
        {
            ...
            if (m_Root != null)
            {
                ...
                var childTransforms = m_Root.GetComponents<NetworkTransformChilds>();
...
//#endif
            ...
            var children = foundObj.GetComponents<NetworkTransformChilds>();
            ...
            NetworkTransformChilds foundSync = children[childIndex];
            if (foundSync == null)
            {
